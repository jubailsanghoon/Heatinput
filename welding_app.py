...
st.markdown(f"""
    ...
    :root {{
        /* 최소 1rem, 화면 폭의 4% 비례, 최대 1.5rem */
        --font-size-master: clamp(1rem, 4vw, 1.5rem);
        /* 최소 1.4rem, 화면 폭의 6% 비례, 최대 2.2rem */
    ...
    div[data-testid="column"]:nth-of-type(1) div[role="radiogroup"] label {{
        ...
        height: auto !important; /* 글자가 두 줄이 되면 박스도 늘어나게 설정 */
    ...
    /* [모바일 전용] 여백 및 레이아웃 다이어트 */
    @media (max-width: 768px) {{
        .stColumn {{ padding: 0 !important; margin-bottom: 15px !important; }}
