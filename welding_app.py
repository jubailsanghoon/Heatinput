...
<style>
    ...
    /* Save Data & Export 버튼 (높이 72px로 강조) */
...
# ======================================================
# 3️⃣ Input Parameters & Live Result Layout
# ======================================================
st.write("") 
...
with col_right:
    ...
    # 버튼 배치: 요청하신 45% : 5% : 45% 비율 적용
    btn_col1, btn_space, btn_col2 = st.columns([45, 5, 45])
